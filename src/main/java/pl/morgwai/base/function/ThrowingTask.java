 ...
 * This allows to precisely declare/infer types of {@link Exception}s thrown by a lambda expression
 * and avoid boilerplate try-catch-rethrowOrIgnore blocks.
 * <p>
 * Java compiler as of version 11 is able to accurately infer types of 0 or 1 {@link Exception}s
 ...
 * such an expression to {@code ThrowingTask} (or {@link Throwing5Task}) with specific type
 * arguments:</p>
 * <pre>{@code
 ...
 */
@FunctionalInterface
public interface ThrowingTask<R, E1 extends Exception, E2 extends Exception>
